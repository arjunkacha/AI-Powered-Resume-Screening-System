...
class ModelTrainer:
    ...
    def train_models(self, X: np.ndarray, y: np.ndarray) -> Dict[str, Any]:
        ...
        for model_name, model in self.models.items():
            ...
            # *** FIT the model here BEFORE getting embeddings (important for TF-IDF) ***
            model.fit(X_train)
            
            # Get embeddings after fitting
            ...
            # Save vectorizer for TF-IDF (important for later inference)
            if model_name == 'tfidf':
    ...
    def evaluate_models(self, X: np.ndarray, y: np.ndarray) -> Dict[str, Any]:
        ...
        for model_name, model in self.models.items():
            ...
            # Load TF-IDF vectorizer if applicable
            if model_name == 'tfidf':
                vectorizer_path = self.model_dir / f"{model_name}_vectorizer.joblib"
